 ...
 * @author MY HP
 */
public class ModelDataKhachHang extends AbstractTableModel{
    
    Vector<model.UsersModel> data=new Vector<>();
    String colNames[] = {"Mã NV","UserName","Password", "Tên NV", "Loại NV","Giới tính", "Ngày sinh","Số điện thoại","email","Tình trạng","Thêm bởi","Ngày tạo"};
    ...
    ModelDataKhachHang(Vector<model.UsersModel> list) {
        data=list;        
    }
