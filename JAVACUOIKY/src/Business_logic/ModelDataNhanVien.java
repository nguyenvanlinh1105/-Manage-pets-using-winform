 ...
 * @author MY HP
 */
public class ModelDataNhanVien extends AbstractTableModel{
    
    Vector<model.UsersModel> data=new Vector<>();
    String colNames[] = {"Mã NV","UserName","Password", "Tên NV", "Loại NV","Giới tính", "Ngày sinh","Số điện thoại","email","Tình trạng","Thông tin"};
    ...
    ModelDataNhanVien(Vector<model.UsersModel> list) {
        data=list;        
    }
