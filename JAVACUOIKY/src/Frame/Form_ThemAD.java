 ...
 * @author Admin
 */
public class Form_ThemAD extends javax.swing.JFrame {
private Business_logic.Admin plHH ;
    private Frame.Admin dv;
    /**
     * Creates new form ThemKhachHang
     */
    public Form_ThemAD() {
        initComponents();
         plHH = new Business_logic.Admin(new Frame.Admin(), this);
        this.plHH.LoadNV();
        
    }
public Form_ThemAD(Frame.Admin HH)
    {
        dv = HH;
        initComponents();
    }
 ...
 plHH = new Business_logic.Admin( new Frame.Admin(), this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_ThemAD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_ThemAD().setVisible(true);
            }
        });
    }
