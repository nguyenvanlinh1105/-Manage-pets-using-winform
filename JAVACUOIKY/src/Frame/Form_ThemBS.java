 ...
 * @author Admin
 */
public class Form_ThemBS extends javax.swing.JFrame {
private Business_logic.BacSi plHH ;
    private Frame.BacSi dv;
    /**
     * Creates new form ThemKhachHang
     */
    public Form_ThemBS() {
        initComponents();
         plHH = new Business_logic.BacSi(new Frame.BacSi(), this);
        this.plHH.LoadBS();
    }
public Form_ThemBS(Frame.BacSi HH)
    {
        dv = HH;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/user-25.png"))); // NOI18N
        ...
        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/icons8-cat-footprint-25.png"))); // NOI18N

        jComboBox2.setBackground(new java.awt.Color(255, 102, 204));
        ...
        jComboBox3.setBackground(new java.awt.Color(255, 102, 204));
        jComboBox3.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N
        jComboBox3.setForeground(new java.awt.Color(102, 0, 102));
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Bác sĩ phẫu thuật", "Bác sĩ chăm sóc", "Bác sĩ khám bệnh", " " }));
        ...
        jLabel6.getAccessibleContext().setAccessibleName("Thêm bác sĩ");
 ...
 plHH = new Business_logic.BacSi( new Frame.BacSi(), this);
    ...
    private void jTextArea1MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTextArea1MouseEntered
        // TODO add your handling code here:
           jTextArea1.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                // Đặt màu đường gạch dưới (border) là màu xanh khi click vào textField
                jTextArea1.setBorder(BorderFactory.createMatteBorder(0, 0, 2, 0, Color.PINK));
            }
        });
        ...
        jTextArea1.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                // Đặt lại màu đường gạch dưới (border) về mặc định khi mất focus
                jTextArea1.setBorder(UIManager.getBorder("TextField.border"));
            }
        });
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_ThemBS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_ThemBS().setVisible(true);
            }
        });
    }
