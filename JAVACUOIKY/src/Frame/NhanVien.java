...
public class NhanVien extends javax.swing.JFrame{
  ...
  private Business_logic.NhanVien blUS;
        private Frame.Form_ThemNV form;

   
    public NhanVien() {
        initComponents();
        blUS = new Business_logic.NhanVien(this);
        form = new Frame.Form_ThemNV(this);
...
private void tbleSPMouseClicked(MouseEvent evt) {
    ...
    private void initComponents() {
        ...
        jTextField2.setText("Tìm kiếm theo idNV");
